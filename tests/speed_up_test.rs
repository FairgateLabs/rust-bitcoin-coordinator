...
//     BlockInfo, ExtraData, TransactionBlockchainStatus, TransactionNews, TransactionStatus,
// };
...
//     let (tx_news, tx, funding_tx) = get_mock_data();
...
//     TransactionNews::Transaction(tx_id.clone(), tx_status.clone(), ExtraData::None);
